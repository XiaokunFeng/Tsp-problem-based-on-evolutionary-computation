...
"""
description: 使用基本的蚁群群优化算法来求解 中国34个城市的TSP问题
"""
import math
import random
import sys
...
def cal_tsp(iter_num):
    ...
    np.save("resource/aco_loss_1.npy", loss)
    ...
    plt.text(iterations[-1] - 20, distance_list[-1], '%.1f' % distance_list[-1], fontdict={'fontsize': 14})
    plt.title('Distance')
    plt.show()
